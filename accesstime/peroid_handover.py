...
while period >= 0:
    ...
    if l4_1 == 1:
        ...
        for i in range(l4_1):
            ...
            access_time = int(float(line1[2]))
            #Select the satellite with the maximum storage capacity
            if access_time >= access_time_comparison:
                satellite_four_parameters = line2
                access_time_comparison = access_time
            else:
                continue
    fp1.close()
