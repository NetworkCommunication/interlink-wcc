...
'''judge whether the satellite is a candidate satellite'''
...
'''calculate the remaining time of satellites'''
...
'''acquire all candidate satellites according to the handover time and save them to the text'''
def Selected_Satellite(str_cutting_time):
