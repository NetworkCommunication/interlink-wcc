...
'''judge the total handover times during different call durations'''
...
while period >= 0:
        ...
        nearest_location = 99999
        fp1 = open("seleted_satellite_1.txt", "r")
        for i in range(l4_1):
            line2 = fp1.readline().rstrip()
            line1 = line2.split("    ")[0].split(" ")
            d = Acquire_Satellite_User_Location(satellite_parameter.rstrip().split("    ")[2], line2)
