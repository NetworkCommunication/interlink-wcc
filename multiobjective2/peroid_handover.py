...
'''
     statistics of total handover times during different call durations
'''
period = 3600   # call duration
total_period = period
handover = 0    # handover times
cutting_time = "17 Sep 2021 05:58:44"
list = []
...
while period >= 0:
            ...
            if line3 != '':
                if "Satellite" in line3:
                    ...
                    if Judge_Time_Size(start_time, satellite_parameter.rstrip().split("    ")[2], end_time) == 1:
                        # calculate the related parameters of candidate satellites and save them into text
        ...
        MAX_Qi_satellite = -9999999    # maximum service quality of satellites
        ...
        if l4_1 == 1:
            ...
            for i in range(l4_1):
                ...
                number = Service_User_Number(cutting_time, line2)
                if number == 0:
                    number = 20
                # call related functions to calculate the fitness of candidate satellites and select the most optimal satelite
                ...
                [data1, data2, data3] = Data_Normalization_Processing(data1, data2, data3)   # satellite parameters normalization
