...
def Judge_Time_Size(start_time, cutting_time, end_time):   # judge whether a satellite is a candidate
...
def Data_Normalization_Processing(remaining_service_time, access_time, storage_size):  # data normalization
...
def Satellite_Visible_Slot_Analysis(cutting_time, visible_slot):   # analyse satellite visibility according to the time slot
    cutting_time = time.strptime(cutting_time, '%d %b %Y %H:%M:%S')
    cutting_time = time.mktime(cutting_time)
